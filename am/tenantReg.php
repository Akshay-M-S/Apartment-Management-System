...
<html>
  ...
  <style>
    ...
    <body>
        ...
        ?>
        <div  style=" background-image: url('img/t.jpg');background-size: fullcover;background-repeat: no-repeat;width: 95%; height:80% ;margin-left: 2%;margin-top: 1.5%;box-shadow: 0px 0px 5px #660066;padding:20px">
            <div>
